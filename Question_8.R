...
# find the answer of Question 8 for participants 20 or younger
hist(Survey_single_choice$Q8[Survey_single_choice$Q3==1])
# we can take two sample t-test to see difference in responses between age groups 
Q3_20_or_younger= Survey_single_choice$Q8[Survey_single_choice$Q3==1]
Q3_21_to_30 = Survey_single_choice$Q8[Survey_single_choice$Q3==2]
Q3_31_to_40 = Survey_single_choice$Q8[Survey_single_choice$Q3==3]
Q3_41_to_50 = Survey_single_choice$Q8[Survey_single_choice$Q3==4]
Q3_51_or_older = Survey_single_choice$Q8[Survey_single_choice$Q3==5]
